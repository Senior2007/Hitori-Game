...
static constexpr auto qt_meta_stringdata_ZN10AuthDialogE = QtMocHelpers::stringData(
    "AuthDialog",
...
Q_CONSTINIT static const uint qt_meta_data_ZN10AuthDialogE[] = {
...
Q_CONSTINIT const QMetaObject AuthDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN10AuthDialogE.offsetsAndSizes,
    qt_meta_data_ZN10AuthDialogE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN10AuthDialogE_t,
        // Q_OBJECT / Q_GADGET
...
void *AuthDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN10AuthDialogE.stringdata0))
